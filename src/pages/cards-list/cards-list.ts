...
export class CardsListPage implements OnInit {
  ...
  constructor(public cardProvider: CardsProvider, public tabs: Tabs, public navCtrl: NavController, public navParams: NavParams, private menuCtrl: MenuController, public events: Events) {
  }
  ...
  displayCard(index: number) {
    ...
    this.navCtrl.push(CardPage, {card: this.display_cards[index]});
  }
